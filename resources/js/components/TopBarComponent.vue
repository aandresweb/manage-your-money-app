<template>
  <div class="top-bar d-flex justify-content-between">
      <div class="left-box">
        <small>Transactions v1.0</small>
      </div>
      <div class="right-box">
        <ul class="nav justify-content-end">
          <li class="nav-item">
            <small>
              <a class="px-2" href="https://www.instagram.com/aandresweb/" target="_blank">
          ...
          <li class="nav-item">
            <small>
              <a class="px-2" href="https://github.com/aandresweb/" target="_blank">
